...
&nbsp;
&nbsp;
### Some of the tools I use to get s(input()) done
<p>
...
<img align="left" alt="Git" width="40px" style="padding-right:10px;" src="https://github.com/devicons/devicon/blob/v2.15.1/icons/git/git-plain.svg" />
  <br/>
</p>
